<div id="footer">
  ...
  <div class="footer_btm">
      <div id="powered"><a href="http://www.opencarttemplate.info" target="_blank">Erk17</a> © <?php echo date("Y");?>  &nbsp; |  &nbsp;  Powered by <a href="http://www.opencart.com/" target="_blank">OpenCart</a></div>
  </div>
</div>
