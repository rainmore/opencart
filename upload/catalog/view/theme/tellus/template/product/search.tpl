...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="buttons">
    <div class="right"><button id="button-search" class="button"><?php echo $button_search; ?></button></div>
  </div>
  <?php if ($products) { ?>
  ...
  <div class="box-product product-list list-layout">
    ...
    <div>
      ...
      <div class="wishlist"><a onclick="addToWishList('<?php echo $product['product_id']; ?>');" class="button"><span class="icon-wishlist-white"><?php echo $button_wishlist; ?></span></a></div>
      <div class="compare"><a onclick="addToCompare('<?php echo $product['product_id']; ?>');" class="button"><span class="icon-compare-white"><?php echo $button_compare; ?></span></a></div>
    </div>
    <?php } ?>
  </div>
...
function display(view) {
	if (view == 'list') {
		...
		$('#container .box .grid-layout > div').each(function(index, element) {
			...
			html += '<div class="name" style="width: ' + <?php echo $this->config->get('config_image_product_width') + 50; ?> + 'px">' + $(element).find('.name').html() + '</div>';
